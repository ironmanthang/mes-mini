...
import productInstanceRoutes from './master-data/product-instances/productInstanceRoutes.js';
import warehouseMasterRoutes from './master-data/warehouses/warehouseRoutes.js';
import qualityChecklistRoutes from './master-data/qualityChecklists/qualityChecklistRoutes.js';
import productCategoryRoutes from './master-data/productCategories/productCategoryRoutes.js';
...
app.use('/api/product-instances', productInstanceRoutes);
app.use('/api/warehouses', warehouseMasterRoutes);
app.use('/api/master-data/quality-checklists', qualityChecklistRoutes);
app.use('/api/master-data/product-categories', productCategoryRoutes);
